                    ...
                    <div className="col-lg-6">
                        <Accordion defaultActiveKey="0">
                            <Accordion.Item eventKey="0">
                                ...
                                <Accordion.Body>
                                    At first go to our website then login and When You Don't Have An Account Please Register First Then Get Premium Access To Our Website ....
                                </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="1">
                                <Accordion.Header>What is the purpose of This Course In your website?</Accordion.Header>
                                <Accordion.Body>
                                    The Main Purpose Of This Website Course Is Mainly Designed For those People Who Are Interested in Programming To Learn
                                </Accordion.Body>
                            </Accordion.Item>
